...
export default function EditProgrammeForm() {
    ...
    const fetchProgramme = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          featuredImage: programme.featuredImage || '',
        });
        if (programme.featuredImage) {
          setImagePreview(programme.featuredImage);
        }
      } catch (err) {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      formDataForUpload.append('folder', 'potter-house/programmes');
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition duration-200">
                  {imagePreview ? (
                    ...
                    <div>
                      ...
                      <p className="text-gray-700 font-semibold mb-1">Upload Programme Image</p>
                      <p className="text-gray-500 text-sm mb-4">
                        Drop your image here or click to browse (Max 5MB)
                      </p>
                    </div>
                  )}
                  <input
                  ...
                  <label
                    ...
                    className="inline-block bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-semibold py-2 px-6 rounded-lg cursor-pointer transition"
                  >
