...
export default function RegistrationForm() {
  ...
  const professions = ['Clergy', 'Medical', 'Education', 'Entreprenuer', 'Civil Servant', 'Information Technology', 'Other'];
  const believerCategories = ['Disciple Maker', 'Disciple', 'Resource Person', 'Returning Attenders', 'Single Time Attender'];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500 to-purple-700 p-8 sm:p-10 flex justify-center items-start mt-[140px]">
        ...
        {showEmailExistsModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Account Already Exists</h2>
              <p className="text-gray-600 mb-2">The email address</p>
              <p className="text-base font-semibold text-purple-600 mb-4 break-all">{existingUserEmail}</p>
              <p className="text-gray-600 mb-6">is already registered in our system.</p>
              
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-gray-700 mb-2"><strong>Ready to take the next step?</strong></p>
                <p className="text-sm text-gray-600">You can now register for one of our available programmes using your existing account.</p>
              </div>

              <div className="flex flex-col gap-3">
                <a
                  href="/available-programmes"
                  className="px-6 py-3 bg-purple-600 text-white border-none rounded-lg text-base font-semibold cursor-pointer transition-all text-center hover:bg-purple-700 hover:shadow-lg"
                >
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gray-200 text-gray-800 border-none rounded-lg text-base font-semibold cursor-pointer transition-all hover:bg-gray-300"
                >
                  Try Another Email
                </button>
              </div>
