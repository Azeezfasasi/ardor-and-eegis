  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="flex items-center gap-2 bg-[#7B542F] text-white px-4 py-2 rounded-lg hover:bg-[#7B542F]/80"
      >
            ...
            <div key={member._id} className="border border-gray-200 rounded-lg p-4 bg-gray-50">
              ...
              <div className="flex items-center gap-2 mt-3">
                <button
                  ...
                  className="flex items-center gap-1 bg-[#7B542F] text-white px-3 py-1 rounded text-sm hover:bg-[#7B542F]/80"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#7B542F]"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#7B542F] resize-none h-20"
              ...
              <div className="flex gap-2 justify-end pt-4">
                ...
                <button
                  type="submit"
                  disabled={uploading}
                  className="px-4 py-2 bg-[#7B542F] text-white rounded-lg hover:bg-[#7B542F]/80 disabled:opacity-50"
                >
