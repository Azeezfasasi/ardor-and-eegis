  ...
  const fetchJob = async () => {
    try {
      ...
      if (data.success) {
        ...
        setRequirements(data.job.requirements && data.job.requirements.length > 0 ? data.job.requirements : [''])
        setBenefits(data.job.benefits && data.job.benefits.length > 0 ? data.job.benefits : [''])
      } else {
