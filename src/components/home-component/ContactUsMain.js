        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-md">
              ...
              <div className="grid gap-6">
                ...
                <button
                  type="submit"
                  className="bg-[#B59C5B] text-white font-semibold px-8 py-3 rounded-lg shadow hover:bg-[#9A7D4A] transition cursor-pointer"
                >
                  Send Message
                </button>
              </div>
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-xl overflow-hidden shadow-md h-64 relative">
              <iframe
                title="Ardor Aegis Limited Location"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3940.567460604333!2d7.440725524780442!3d9.011887091048713!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104e0d000d7ac7e5%3A0xd090caf337ec446c!2sKaura%20District%2C%20Abuja!5e0!3m2!1sen!2sng!4v1778160374258!5m2!1sen!2sng"
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://facebook.com" target="_blank" className="hover:text-[#B59C5B] transition">
                <Facebook size={24} />
              </a>
              <a href="https://linkedin.com" target="_blank" className="hover:text-[#B59C5B] transition">
                <Linkedin size={24} />
              </a>
              <a href="https://instagram.com" target="_blank" className="hover:text-[#B59C5B] transition">
                <Instagram size={24} />
              </a>
            </div>
          </div>
