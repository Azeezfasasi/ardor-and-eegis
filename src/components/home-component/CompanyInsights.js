          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center px-2">
              <p className="text-gray-700 text-sm md:text-base max-w-3xl mx-auto leading-relaxed">
                At Ardor Aegis Security Company Limited, we believe that every client deserves a security solution tailored to their unique environment and challenges. By combining professionally trained personnel, advanced surveillance systems, and proactive security strategies, we provide comprehensive protection that ensures confidence and peace of mind.
              </p>
            </div>
          </div>
        </div>
