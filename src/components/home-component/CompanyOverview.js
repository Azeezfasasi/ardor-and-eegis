        ...
        <div className="container mx-auto px-6 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <div className="relative w-full h-64 sm:h-80 lg:h-96 rounded-xl overflow-hiddens shadow-lg">
                <Image
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed">
                {data.companyInfo.paragraphs && data.companyInfo.paragraphs.sort((a, b) => (a.order || 0) - (b.order || 0)).map((para, idx) => (
                  <p key={idx} className={idx === data.companyInfo.paragraphs.length - 1 ? "text-[#7B542F] font-semibold text-lg pt-2" : ""}>
                    {para.text}
                  </p>
                ))}
              </div>
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-lg shadow-md p-8 md:p-12 border-l-4 border-[#7B542F]">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-6 lg:px-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-[#7B542F]/5 to-[#7B542F]/10 rounded-lg shadow-md p-8 md:p-12 border-l-4 border-[#7B542F]">
              <p className="text-xl text-gray-700 leading-relaxed">
