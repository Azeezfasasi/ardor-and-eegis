        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="mt-4 text-lg text-gray-600 leading-relaxed">
              At Ardor Aegis Security Company Limited, we deliver professional security and protection services designed to safeguard people, properties, businesses, and critical assets. Our highly trained personnel and advanced security strategies ensure reliable protection, rapid response, and peace of mind for every client.
            </p>
          </div>
