...
export default function MainNav() {
  return (
    <>
      {/* Header Section */}
      <header className="relative w-full h-screen bg-cover bg-center bg-no-repeat pt-[150px]" style={{backgroundImage: `url('https://images.unsplash.com/photo-1552664730-d307ca884978?w=1200&h=600&fit=crop')`}}>
        {/* Dark Overlay */}
