    ...
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-[20px] md:text-2xl font-bold text-gray-900 flex items-center space-x-2">
          <Send className="w-5 md:w-8 h-5 md:h-8 text-[#7B542F]" />
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7B542F]"
            />
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <textarea
              ...
              rows={10}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7B542F] font-mono text-sm"
            />
          </div>
        </div>
        ...
        <div className="space-y-6">
                  ...
                  {['vip', 'active', 'engaged', 'new'].map(tag => (
                    <label key={tag} className="flex items-center space-x-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 text-[#7B542F] rounded"
                      />
            ...
            {formData.recipientType === 'segment' && (
              <div className="mt-4 pt-4 border-t border-gray-200">
                <input
                  ...
                  className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7B542F]"
                />
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-3">
            <button
              ...
              disabled={isLoading}
              className="w-full px-4 py-3 bg-[#7B542F] text-white rounded-lg font-medium hover:bg-[#7B542F]/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            >
          ...
          {/* Tips */}
          <div className="bg-[#7B542F]/10 border border-[#7B542F]/50 rounded-lg p-4">
            <div className="flex items-start space-x-3">
              <Sparkles className="w-5 h-5 text-[#7B542F]/70 shrink-0 mt-0.5" />
              <div>
                <p className="text-sm font-semibold text-[#7B542F]">Pro Tip</p>
                <ul className="text-xs text-[#7B542F]/80 mt-2 space-y-1">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7B542F]"
            />
          </div>
        </div>
      </Modal>
