                      ...
                      <div className="space-y-2 pt-4 border-t border-gray-200">
                        <div className="flex gap-2 flex-wrap">
                          <button
                            ...
                            className="flex items-center justify-center gap-2 px-3 py-2 bg-[#7B542F] text-[#7B542F] rounded hover:bg-[#7B542F]/80 transition-colors text-sm font-medium flex-1"
                          >
