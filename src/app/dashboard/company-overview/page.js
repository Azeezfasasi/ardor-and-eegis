        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#7B542F]"
                />
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-center w-full px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#7B542F] hover:bg-[#7B542F]/10 transition">
                  ...
                  {companyInfoForm.paragraphs.map((para, idx) => (
                    <div key={idx} className="flex gap-2">
                      <textarea
                        ...
                        rows="3"
                        className="flex-1 px-3 py-2 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-[#7B542F]"
                      />
              ...
              <button onClick={saveCompanyInfo} disabled={saving} className="w-full px-4 py-2.5 bg-[#7B542F] text-white rounded-lg hover:bg-[#7B542F]/80 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
          ...
          {activeTab === 'vision' && (
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              ...
              <button onClick={saveVision} disabled={saving} className="w-full px-4 py-2.5 bg-[#7B542F] text-white rounded-lg hover:bg-[#7B542F]/80 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
                {saving && <Loader className="w-4 h-4 animate-spin" />}
                Save Vision
              </button>
            </div>
          ...
          {activeTab === 'mission' && (
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
              ...
              <button onClick={saveMission} disabled={saving} className="w-full px-4 py-2.5 bg-[#7B542F] text-white rounded-lg hover:bg-[#7B542F]/80 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
                {saving && <Loader className="w-4 h-4 animate-spin" />}
                Save Mission
              </button>
            </div>
          ...
          {activeTab === 'coreValues' && (
            <div className="bg-white rounded-lg shadow p-6 space-y-6">
                ...
                <div className="space-y-2">
                  {coreValuesForm.map((value, idx) => (
                    <div key={idx} className="flex items-center gap-3 p-3 border border-gray-200 rounded-lg bg-white">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => handleEditCoreValue(idx)} className="text-[#7B542F] hover:text-[#7B542F]/80">
              ...
              <button onClick={saveCoreValues} disabled={saving} className="w-full px-4 py-2.5 bg-[#7B542F] text-white rounded-lg hover:bg-[#7B542F]/80 font-medium disabled:opacity-50 flex items-center justify-center gap-2">
                {saving && <Loader className="w-4 h-4 animate-spin" />}
                Save Core Values
              </button>
            </div>
